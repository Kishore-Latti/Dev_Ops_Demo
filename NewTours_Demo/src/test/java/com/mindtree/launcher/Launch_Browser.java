...
public class Launch_Browser {
	...
	public void demo()
	{
		System.out.println(" to show different package usage");
	}
	...
	public void launchpage(String browser , String url )
	{
		...
		{
			System.setProperty("webdriver.ie.driver",path+"\\src\\test\\resources\\IEDriverServer.exe");
