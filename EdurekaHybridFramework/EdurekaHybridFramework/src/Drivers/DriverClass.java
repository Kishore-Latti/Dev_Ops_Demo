...
public class DriverClass {
	...
	private static String sDriverPropertyFile = "D:\\Selenium_Edureka\\Selenium-Workspace\\EdurekaHybridFramework\\EdurekaHybridFramework\\src\\conf\\AutomationInput.properties";
	...
	public static void main(String[] args) {
		...
		sInputFileFolder = oDriverProperties.getProperty("InputFileFolder")
				.trim();
		sMainDriverInputFile = oDriverProperties.getProperty("DriverInputFile")
				.trim();
	...
	private static void exportToExcel() {
		...
		sOutputFileName = sResultFolder + "\\Result as on " + sDateTimeStamp
				+ ".xlsx";
