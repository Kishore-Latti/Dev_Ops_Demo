...
public class Utils {
	...
	public static By getLocatorBy(String sLocatorString){//id:=email
		try{
			...
			if(aLocator[0].equalsIgnoreCase("id")){//id.equalsIgnoreCase("id")
				return By.id(aLocator[1]);//By.id("email")
			}
